...
public class ImpressionInsertService implements AutoCloseable {
    ...
    private static final int IMPRESSION_DURATION = 2;
    ...
    public ImpressionInsertService(int batchLimit) {
    ...
    public void insert(String[] request) {
        Session session = new Session(request[SESSION_ID], null,
                null, null, null,
                null, Long.parseLong(request[IMPRESSION_DURATION]), null);
    ...
    public void sendBatch() {
        mSessionDao.insertOrUpdateSessions(FileType.impressions, sessionsList);
